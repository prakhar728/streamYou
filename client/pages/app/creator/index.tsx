...
const index = () => {
  ...
  return (
    <Navbar>
        ...
        <Box  w="100%" h="80vh" display={"flex"} alignItems={"center"} flexDirection={"column"} justifyContent={"space-evenly"} rowGap={3}>
            <Box w="100%" display={"flex"} flexDirection={"row"}>
                <Box  display={"flex"} justifyContent={"center"} alignItems={"center"}>
                    <Image src={"https://pbs.twimg.com/media/FOHih5gWYAIbRPX?format=jpg&name=small"} width={"40%"} borderRadius={"50%"}/>
                </Box>
                <Box padding={2} display={"flex"} justifyContent={"space-evenly"} flexDirection={"column"}>
                    ...
                    <Text size={"lg"}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat ipsum distinctio dolores tenetur natus error consequuntur, neque quos dolorum itaque nemo quae iusto voluptatem? Dignissimos hic excepturi laborum saepe minus?</Text>
                </Box>
                <Center p={2}>
